...
<section class="main-wrap-auth" style="
        background: url(../assets/images/about-layer.png);
    ...
    <div class="px-custom text-center">
        <a href="#" class="rounded-pill text-decoration-none bg-transparent text-uppercase btn-theme-outline">
            Learn More
        </a>
    </div>
</section>
